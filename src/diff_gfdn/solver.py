...
class MLPTuningConfig:
    ...
    def __init__(self, config_dict: DiffGFDNConfig, room_data: RoomDataset,
                 train_dataset: DataLoader, valid_dataset: DataLoader):
        """
        Args:
...
def mlp_hyperparameter_tuning(trial, hyp_config: MLPTuningConfig):
    ...
    model = DiffGFDNVarReceiverPos(
        ...
        room_dims=hyp_config.room_data.room_dims,
        absorption_coeffs=hyp_config.room_data.absorption_coeffs,
