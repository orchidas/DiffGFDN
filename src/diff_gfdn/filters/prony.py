...
def prony(h: NDArray, nb: int, na: int) -> Tuple[NDArray, NDArray]:
...
def allpass_warp(ir: NDArray, rho: float) -> NDArray:
...
def prony_warped(h: NDArray,
                 fs: float,
                 nb: int,
                 na: int,
                 rho: Optional[float] = None) -> Tuple[NDArray, NDArray]:
